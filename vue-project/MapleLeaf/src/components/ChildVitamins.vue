...
let ChildVitamins = ref([
    ...
    {type:"C", badges:[BadgeShield,BadgeEnergy],img: BVitamin,fullName:true,effects:["skin"], color:"#E6FFD6", desc:"A-vitamin bidrager til at vedligeholde normalt syn og normal hud"},
